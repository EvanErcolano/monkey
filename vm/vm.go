...
// exectueCall checks what type of function is about to be called on the stack
// and then dispatches to the appropriate calling method.
func (vm *VM) executeCall(numArgs int) error {
	// get our function off the stack
...
func (vm *VM) callBuiltin(builtin *object.Builtin, numArgs int) error {
	// pick up the arguments off the stack
	args := vm.stack[vm.sp-numArgs : vm.sp]
	result := builtin.Fn(args...)

	// take the arguments and function we executed off the stack
